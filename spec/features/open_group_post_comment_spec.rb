...
feature 'Open Groups Post Comment Functionality' do
  ...
  scenario 'Can comment a post if user is admin' do
    ...
    fill_in 'open_group_post_content', with: 'hiii :)'
  ...
  scenario 'Can\'t comment a post if user is not in group' do
    visit '/create_open_group'
  ...
  scenario 'Can\'t comment a post if there is no post' do
    visit '/create_open_group'
